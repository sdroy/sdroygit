...
<% Html.Telerik().Grid<FileModel>()
        ...
        .DataBinding(dataBinding => dataBinding.Ajax()
                    .Select("SelectFiles", "UserRepository", new { filePath = Model.FullPath })
                    )
        ...
        .Selectable()
        .ClientEvents(events => events.OnRowSelect("onRowSelected_userGrid").OnDataBound("onDocumentsGridDataBound"))
...
<script type="text/javascript">
    ...
    function menuLoad() {
        ...
        $.ajax({
            type: "POST",
            url: "/UserRepository/GetDocumentUserMenu",
    ...
    function onRowSelected_userGrid(e) {
